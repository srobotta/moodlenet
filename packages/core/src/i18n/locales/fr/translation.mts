export const translations: Translations = {
  ...
  new_bookmark_on_your_profile_or_contribution:'Nouveau favori sur mon profil ou une de mes contributions',
  ...
  report:'Report',
  report_comment_placeholder:'C’est du spam / commercial / pas éducatif / fraudulezx / protégé / autre raison.',
  required_field:'Champ requis',
  resource:'Ressource',
  resources:'Ressources',
  rooted_learner:'Plantule enracinée',
  scheduled_maintenance:'MoodleNet est indisponible pour une maintenance programmée et devrait être en ligne sous peu.',
  search:'Rechercher',
  ...
  text_area_value:'C’est la description qui vous dit qu’il ne s’agit pas seulement du meilleur contenu qui soit, mais aussi du plus dynamique et du plus réjouissant que vous puissiez trouver. Faites-nous confiance.',
