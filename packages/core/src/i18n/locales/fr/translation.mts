...
export const translations: Translations = {
  ...
  lms_btn_send: 'Envoyer',
  lms_modal_desc: 'Entrez l’URL de votre site Moodle pour envoyer cette ressource',
  lms_modal_title: 'Envoyer à Moodle',
  ...
  lms_user_id_copied:
    'Identifiant utilisateur a été copié dans le presse-papiers, utilisez-le dans Moodle.',
  lms_user_id_login: 'Connectez-vous avec votre identifiant de Switch edu-ID.',
  lms_user_id_required: 'Peut-être que tu en as besoin',
  ...
  send_a_message_to: 'Envoyer un message à {1}.',
  ...
  signup: 'S’inscrire',
  signup_check_mail: 'Vérifiez vos e-mails pour confirmer votre inscription.',
  signup_email_sent: 'Email envoyé!',
