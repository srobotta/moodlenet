...
export const translations: Translations = {
  ...
  advanced_email_be_sent:
    'Un e-mail vous sera envoyé pour confirmer la suppression de votre compte.', //@todo check BB_2024-03-21
  ...
  report_comment_placeholder:
    'C’est du spam / commercial / pas éducatif / fraudulezx / protégé / autre raison.',
  ...
  settings_use_interests_as_default:
    'Utiliser les centres d’intérêt comme filtres par défaut lors des recherches', //@todo check BB_2024-03-21
  share: 'Partager',
